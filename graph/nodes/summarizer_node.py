...
- What to expect:
  - Short-term (next 1-2 years): [General trends and themes - describe what's happening now and in the near future, what opportunities or challenges are emerging, use simple language like "upcoming months" or "next year" rather than specific dates. Include 3-4 key points about immediate focus areas. Don't include specific dates.]
  - Medium-term (2-5 years): [Broader patterns and opportunities - describe evolving situations, potential growth areas, and how things might develop. Focus on general timeframes like "in the next few years" or "around mid-decade", not exact dates. Include 3-4 key developments to watch for. Don't include specific dates.]
  - Long-term (5-10 years): [Overall direction and potential - describe the bigger picture trajectory, major life themes, and where things are heading. Keep it high-level and encouraging, focusing on general direction rather than specifics. Include 2-3 key long-term themes. Don't include specific dates.]
...
**Avoid**: 
- Excessive specific dates (limit to 3-4 key milestones per goal)
